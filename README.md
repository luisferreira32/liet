...
Did you ever think: I need an application to manage my finances? Then look no more! Microsoft Excel is the perfect tool for you! However, if you want a terminal based application to track how expensive your life is without anything too fancy, give _liet_ a chance.
...
```bash
go install github.com/luisferreira32/liet@latest
```
...
The first rule of _liet_ is that you're one _l_ away from f\*in it up. So just do everyone a favor and use an alias:
...
Go check [CONTRIBUTING](./CONTRIBUTING.md)!
